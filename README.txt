...
----------------------------------------------------------------
Welcome to Pega Platform 8.1 Personal Edition.
...
Your kit contains the following installation and educational components:
	...
	*  Pega Platform 8.1 Personal Edition software to support the Windows 64 bit operating system
...
The kit contains the following files and folders:
	...
	* 'jdk1.8.0_121' folder
	* 'install.bat' file
	* '81ThirdPartyLicense.pdf' document
	* 'PRPC_PE.jar' file
	* 'README.txt' file
...
Installing Personal Edition
	...
	To install Personal Edition, double-click the install.bat Windows Batch file. Directions can be found on the PDN at https://community1.pega.com/digital-delivery
...
Personal Edition Release Information
	...
	https://community1.pega.com/digital-delivery
